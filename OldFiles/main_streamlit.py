...
st.title("Contract Processing App")
...
if uploaded_files:
    ...
    st.write("############# Starting Openai Processing ######################")
    ...
    if run_open_ai:
        ...
        base_name = os.path.basename(pdf_document.name)
        ...
        st.write("Message content saved successfully!")
        ...
        st.write(f"Data has been exported to {file_path}")
