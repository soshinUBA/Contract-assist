...
async def process_contract(background_tasks: BackgroundTasks, folder_path: str = Body(..., embed=True)):
    """
    ...
    background_tasks.add_task(process_contract_task, task_id, folder_path, os.path.basename(folder_path))
